...
def sequence_definition():
    for _ in range(1000):
        random_data = get_random_sequence()
        result = verify_sequence(random_data)
        print(random_data)
        print(result)
...
def main():
    ...
    print('training')
    iter = TRAIN_ITER // EPOCH_ITER
    for epoch in range(iter):
        proportion_supervised = max(0.0, 1.0 - CURRICULUM_RATE * epoch)
        print('epoch:', epoch, ' / total:', iter, ' / proportion_supervised: ', proportion_supervised)
        train.train_epoch(
